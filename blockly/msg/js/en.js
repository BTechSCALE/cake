...
Blockly.Msg.MATH_ASSIGNMENT_BY_PLUS_EQUAL = "+=";
Blockly.Msg.MATH_ASSIGNMENT_BY_MINUS_EQUAL = "-=";
Blockly.Msg.MATH_ASSIGNMENT_BY_TIMES_EQUAL = "*=";
Blockly.Msg.MATH_ASSIGNMENT_BY_DIVIDE_EQUAL = "/=";
Blockly.Msg.MATH_ASSIGNMENT_BY_MODULO_EQUAL = "%=";
Blockly.Msg.MATH_ASSIGNMENT_BY_TOOLTIP = "Reassign a variable by performing a math operation on it";
...
Blockly.Msg.MATH_TRIG_LOG = "ln";
Blockly.Msg.MATH_TRIG_LOG10 = "lg";
...
Blockly.Msg.MATH_POW_TITLE = '%1 to the power %2'; //'pow %1 ^ %2';
Blockly.Msg.MATH_EXP_TITLE = 'e^';
Blockly.Msg.MATH_SQRT_TITLE = '√';
Blockly.Msg.MATH_ABS_TITLE = 'abs'; // not use
...
Blockly.Msg.TAG_MATH_ASSIGNMENT_BY = ['number', '+=', '-=', '*=', '/=', '%='];
